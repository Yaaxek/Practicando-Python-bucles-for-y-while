"""
Marcos está desarrollando un programa para mostrar un 
mensaje de bienvenida repetidamente en la consola, 
...
mensaje: "¡Bienvenido a Buscante!" el número exacto de 
veces que necesita.
"""
for mensaje in range(5):
